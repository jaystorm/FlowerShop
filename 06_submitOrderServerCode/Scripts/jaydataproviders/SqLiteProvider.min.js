...
var b=null;return this.connection=b=this.providerConfiguration.storage?new $data.dbClient.jayStorageClient.JayStorageConnection(a):"undefined"!==typeof sqLiteModule?new $data.dbClient.sqLiteNJClient.SqLiteNjConnection(a):new $data.dbClient.openDatabaseClient.OpenDbConnection(a)},supportedDataTypes:{value:[$data.Integer,$data.String,$data.Number,$data.Blob,$data.Boolean,$data.Date,$data.Guid],writable:!1},fieldConverter:{value:{fromDb:{"$data.Integer":function(a){return a},"$data.Number":function(a){return a},
"$data.Date":function(a){return new Date(a)},"$data.String":function(a){return a},"$data.Boolean":function(a){return 1===a?!0:!1},"$data.Blob":function(a){return a},"$data.Guid":function(a){return a?$data.parseGuid(a):a}},toDb:{"$data.Integer":function(a){return a},"$data.Number":function(a){return a},"$data.Date":function(a){return a?a.valueOf():null},"$data.String":function(a){return a},"$data.Boolean":function(a){return a?1:0},"$data.Blob":function(a){return a},"$data.Guid":function(a){return a?
a.value:a},"$data.Object":function(a){if(null===a)return null;throw"Not supported exception";}}}},supportedFieldOperations:{value:{length:{dataType:"number",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.ProjectionExpression]},substr:{dataType:"string",allowedIn:$data.Expressions.FilterExpression,parameters:[{name:"startFrom",dataType:"number"},{name:"length",dataType:"number"}]},toLowerCase:{dataType:"string",mapTo:"lower"},toUpperCase:{dataType:"string",mapTo:"upper"},contains:{mapTo:"like",
dataType:"boolean",allowedIn:$data.Expressions.FilterExpression,parameters:[{name:"strFragment",dataType:"string",prefix:"%",suffix:"%"}]},startsWith:{mapTo:"like",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.ProjectionExpression],parameters:[{name:"strFragment",dataType:"string",suffix:"%"}]},endsWith:{mapTo:"like",dataType:"boolean",allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.ProjectionExpression],parameters:[{name:"strFragment",dataType:"string",
prefix:"%"}]},trim:{dataType:$data.String,allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.ProjectionExpression],mapTo:"trim",parameters:[{name:"@expression",dataType:$data.String},{name:"chars",dataType:$data.String}]},ltrim:{dataType:$data.String,allowedIn:[$data.Expressions.FilterExpression,$data.Expressions.ProjectionExpression],mapTo:"ltrim",parameters:[{name:"@expression",dataType:$data.String},{name:"chars",dataType:$data.String}]},rtrim:{dataType:$data.String,allowedIn:[$data.Expressions.FilterExpression,
$data.Expressions.ProjectionExpression],mapTo:"rtrim",parameters:[{name:"@expression",dataType:$data.String},{name:"chars",dataType:$data.String}]}},enumerable:!0,writable:!0},supportedBinaryOperators:{value:{equal:{mapTo:"=",dataType:"boolean",nullMap:" is null"},notEqual:{mapTo:"!=",dataType:"boolean",nullMap:" is not null"},equalTyped:{mapTo:"=",dataType:"boolean"},notEqualTyped:{mapTo:"!=",dataType:"boolean"},greaterThan:{mapTo:">",dataType:"boolean"},greaterThanOrEqual:{mapTo:">=",dataType:"boolean"},
lessThan:{mapTo:"<",dataType:"boolean"},lessThenOrEqual:{mapTo:"<=",dataType:"boolean"},or:{mapTo:"OR",dataType:"boolean"},and:{mapTo:"AND",dataType:"boolean"},add:{mapTo:"+",dataType:"number"},divide:{mapTo:"/"},multiply:{mapTo:"*"},subtract:{mapTo:"-"},modulo:{mapTo:"%"},orBitwise:{maptTo:"|"},andBitwsise:{mapTo:"&"},"in":{mapTo:"in",dataType:"boolean"}}},supportedUnaryOperators:{value:{not:{mapTo:"not"},positive:{mapTo:"+"},negative:{maptTo:"-"}}},supportedSetOperations:{value:{filter:{},map:{},
length:{},forEach:{},toArray:{},single:{},take:{},skip:{},orderBy:{},orderByDescending:{},first:{},include:{}},enumerable:!0,writable:!0},buildDbType_modifyInstanceDefinition:function(a,b){var c=function(a){var b=JSON.parse(JSON.stringify(a));b.dataType=Container.resolveType(a.dataType);b.key=!1;b.computed=!1;return b},d=function(a,b,d,c){var i={};i[a.name]=d;i[b.name]=c+"__"+d;return i};b.Associations&&b.Associations.forEach(function(b){var f=!1,g=b.FromType,h=b.ToType,i=b.ToPropertyName;b.ReferentialConstraint=
b.ReferentialConstraint||[];if("*"==b.FromMultiplicity&&"0..1"==b.ToMultiplicity||"0..1"==b.FromMultiplicity&&"1"==b.ToMultiplicity)g=b.ToType,h=b.FromType,i=b.FromPropertyName,f=!0;g.memberDefinitions.getPublicMappedProperties().filter(function(a){return a.key}).forEach(function(j){f&&(a[i+"__"+j.name]=c(j));b.ReferentialConstraint.push(d(g,h,j.name,i))},this)},this);b.ComplexTypes&&b.ComplexTypes.forEach(function(b){b.ReferentialConstraint=b.ReferentialConstraint||[];b.ToType.memberDefinitions.getPublicMappedProperties().forEach(function(f){a[b.FromPropertyName+
"__"+f.name]=c(f);b.ReferentialConstraint.push(d(b.ToType,b.FromType,f.name,b.FromPropertyName))},this)},this)},buildDbType_generateConvertToFunction:function(a){return function(b){var c=new a.PhysicalType;c.entityState=b.entityState;a.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(a){c[a.name]=b[a.name]},this);a.Associations&&a.Associations.forEach(function(a){if("*"==a.FromMultiplicity&&"0..1"==a.ToMultiplicity||"0..1"==a.FromMultiplicity&&"1"==a.ToMultiplicity){var e=
b[a.FromPropertyName];void 0!==e&&a.ReferentialConstraint.forEach(function(b){c[b[a.From]]=null!==e?e[b[a.To]]:null},this)}},this);a.ComplexTypes&&a.ComplexTypes.forEach(function(a){var e=b[a.FromPropertyName];void 0!==e&&a.ReferentialConstraint.forEach(function(b){c[b[a.From]]=null!==e?e[b[a.To]]:null},this)},this);return c}},initializeStore:function(a){a=$data.typeSystem.createCallbackSetting(a);this.context._storageModel.forEach(function(a){this.SqlCommands.push(this.createSqlFromStorageModel(a)+
" ")},this);var b=this._createSqlConnection(),c=this;b.createCommand("SELECT * FROM sqlite_master WHERE type = 'table'",null).executeQuery({success:function(d){for(var e={},f=0;f<d.rows.length;f++){var g=d.rows[f];e[g.tbl_name]=g}switch(c.providerConfiguration.dbCreation){case $data.storageProviders.DbCreationType.Merge:Guard.raise(new Exception("Not supported db creation type"));break;case $data.storageProviders.DbCreationType.DropTableIfChanged:d=[];for(f=0;f<c.SqlCommands.length;f++)if(""!=c.SqlCommands[f]){var h=
/^CREATE TABLE IF NOT EXISTS ([^ ]*) (\(.*\))/g.exec(c.SqlCommands[f]);if(h&&(g=h[1],h=h[2],e[g.slice(1,g.length-1)])){var i=/^CREATE TABLE ([^ ]*) (\(.*\))/g.exec(e[g.slice(1,g.length-1)].sql)[2];h.toLowerCase()!=i.toLowerCase()&&d.push("DROP TABLE IF EXISTS ["+e[g.slice(1,g.length-1)].tbl_name+"];")}}c.SqlCommands=c.SqlCommands.concat(d);break;case $data.storageProviders.DbCreationType.DropAllExistingTables:for(h in e)h&&!h.match("^__")&&!h.match("^sqlite_")&&c.SqlCommands.push("DROP TABLE IF EXISTS ["+
...
d,c,a)},saveIndependentBlocks:function(a,b,c,d){function e(){if(0===g.length)d.success();else{var a=g.shift().map(function(a){var b=f.context._storageModel.getStorageModel(a.data.getType()).PhysicalType;a.physicalData=b.convertTo(a.data);return a},this);f.saveIndependentItems(a,c,{success:function(){f.postProcessItems(a);e()},error:d.error})}}var f=this,g=[].concat(b);e()},saveIndependentItems:function(a,b,c){function d(a,b){var c=[],d=[];b.forEach(function(a,b){if(a&&(a.query&&(c[b]=a.query),a.param))d[b]=
a.param});return a.createCommand(c,d)}var e=this,f=a.map(function(a){return e.saveEntitySet(a)}),f=f.filter(function(a){return a});0===f.length?c.success(a):d(b,f).executeQuery({success:function(f){f=f.map(function(c,d){return c&&c.insertId?e.save_reloadSavedEntity(c.insertId,a[d].entitySet.tableName,b):null});f=d(b,f);0<f.query.length?f.executeQuery(function(b){b.forEach(function(b,c){b&&b.rows&&(a[c].physicalData.initData=b.rows[0])});c.success(a)}):c.success(0)},error:c.error})},postProcessItems:function(a){function b(a){var b=
a.name;if(c.hasOwnProperty(b))return c[b];a=a.memberDefinitions.getPublicMappedProperties().filter(function(a){return a.computed});return c[b]=a}var c={};a.forEach(function(a){a.physicalData&&b(a.data.getType()).forEach(function(b){a.data[b.name]=a.physicalData[b.name]},this)},this)},saveEntitySet:function(a){switch(a.data.entityState){case $data.EntityState.Added:return this.save_NewEntity(a);case $data.EntityState.Deleted:return this.save_DeleteEntity(a);case $data.EntityState.Modified:return this.save_UpdateEntity(a);
case $data.EntityState.Unchanged:break;default:Guard.raise(new Exception("Not supported entity state"))}},save_DeleteEntity:function(a){for(var b="DELETE FROM ["+a.entitySet.name+"] WHERE(",c=!1,d=!1,e=[];!c;)a.physicalData.constructor.memberDefinitions.getPublicMappedProperties().forEach(function(f){c&&!b.match(" AND $")&&(b+=" AND ");if(f.key||d)b+="(["+f.name+"] == ?)",e.push(this.fieldConverter.toDb[Container.resolveName(f.dataType)](a.data[f.name])),c=!0},this),c||(d=!0);b.match(" AND $")&&(b=
b.slice(0,b.length-5));b+=");";return{query:b,param:e}},save_UpdateEntity:function(a){var b=" SET ",c="WHERE(",d=!1,e=[],f=[];a.physicalData.constructor.memberDefinitions.getPublicMappedProperties().forEach(function(g){void 0!==a.physicalData[g.name]&&(d&&!c.match(" AND $")&&(c+=" AND "),5<b.length&&!b.match(",$")&&(b+=","),g.key?(c+="(["+g.name+"] == ?)",e.push(this.fieldConverter.toDb[Container.resolveName(g.dataType)](a.physicalData[g.name])),d=!0):(b+="["+g.name+"] = ?",f.push(this.fieldConverter.toDb[Container.resolveName(g.dataType)](a.physicalData[g.name]))))},
...
if(void 0!==a.physicalData[g]&&b.dataType&&(!b.dataType.isAssignableTo||b.dataType.isAssignableTo&&!b.dataType.isAssignableTo($data.EntitySet)))d+="?",c+="["+g+"]",e.push(this.fieldConverter.toDb[Container.resolveName(b.dataType)](a.physicalData[g]))},this);1>e.length&&Guard.raise(new Exception("None of the fields contain values in the entity to be saved."));","==c[c.length-1]&&(c=c.slice(0,c.length-1));","==d[d.length-1]&&(d=d.slice(0,d.length-1));return{query:b+(c+") VALUES("+d+");"),param:e}},
save_reloadSavedEntity:function(a,b){return{query:"SELECT * FROM "+b+" WHERE rowid=?",param:[a]}},createSqlFromStorageModel:function(a){(void 0===a||null===a||void 0===a.PhysicalType)&&Guard.raise("StorageModel not contains physical entity definition");var b=0,c=0;a.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(a){a.key&&b++;a.computed&&c++},this);1===c&&1<b&&Guard.raise(new Exception("Do not use computed field with multiple primary key!"));1<c&&1<b&&Guard.raise(new Exception("Do not use multiple computed field!"));
var d="CREATE TABLE IF NOT EXISTS ["+a.TableName+"] (",e=",PRIMARY KEY (";a.PhysicalType.memberDefinitions.getPublicMappedProperties().forEach(function(b,g){0<g&&!d.match(", $")&&!d.match("\\($")&&(d+=", ");d+=this.createSqlFragmentFromField(b,1===c,a);0===c&&b.key&&(14<e.length&&!e.match(", $")&&(e+=", "),e+="["+b.name+"]")},this);d.match(", $")&&(d=d.substr(0,d.length-2));0===c&&14<e.length&&(d+=e+")");return d+=");"},createSqlFragmentFromField:function(a,b,c){return"schemaCreate"in a&&a.schemaCreate?
a.schemaCreate(a):(new this.FieldTypeBuilder(a,this,b,c)).build()},FieldTypeBuilder:function(a,b,c,d){this.fieldDef="";this.fld=a;this.provider=b;this.parsePk=c;this.entitySet=d;this.build=function(){switch(Container.resolveType(this.fld.dataType)){case $data.String:case $data.Guid:case "text":case "string":this.buildFieldNameAndType("TEXT");break;case $data.Boolean:case $data.Integer:case "bool":case "boolean":case "int":case "integer":this.buildFieldNameAndType("INTEGER");break;case $data.Number:case $data.Date:case "number":case "datetime":case "date":this.buildFieldNameAndType("REAL");
